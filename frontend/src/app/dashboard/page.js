  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-6 sm:p-8">
          ...
          {user.role === "ADMIN" && (
            <>
              <button
                ...
                className={`py-3.5 px-1 border-b-2 font-bold text-sm transition-all whitespace-nowrap ${activeTab === "reports" ? "border-blue-200 text-blue-600 " : "border-transparent text-gray-600"}`}
              >
                System Audit Reports
              </button>
              <button
                onClick={() => setActiveTab("physicians")}
                className={`py-3.5 px-1 border-b-2 font-bold text-sm transition-all whitespace-nowrap ${activeTab === "physicians" ? "border-blue-200 text-blue-600 " : "border-transparent text-gray-600"}`}
              >
                Physician Registry
              </button>
            </>
          ...
          {(user.role === "RECEPTIONIST" || user.role === "ADMIN") && (
            <>
              <button
                ...
                className={`py-3.5 px-1 border-b-2 font-bold text-sm transition-all whitespace-nowrap ${activeTab === "patients" ? "border-blue-200 text-blue-600 " : "border-transparent text-gray-600"}`}
              >
                Patient Registry Directory
              </button>
              <button
                onClick={() => setActiveTab("book")}
                className={`py-3.5 px-1 border-b-2 font-bold text-sm transition-all whitespace-nowrap ${activeTab === "book" ? "border-blue-200 text-blue-600 " : "border-transparent text-gray-600"}`}
              >
          ...
          {user.role === "DOCTOR" && (
            <>
              <button
                ...
                className={`py-3.5 px-1 border-b-2 font-bold text-sm transition-all whitespace-nowrap ${activeTab === "appointments" ? "border-blue-200 text-blue-600 " : "border-transparent text-gray-600"}`}
              >
                My Scheduled Bookings
              </button>
              <button
                onClick={() => setActiveTab("queue")}
                className={`py-3.5 px-1 border-b-2 font-bold text-sm transition-all whitespace-nowrap ${activeTab === "queue" ? "border-blue-200 text-blue-600 " : "border-transparent text-gray-600"}`}
              >
        ...
        {checkinMessage && (
          <div className="p-4 mb-6 rounded-xl bg-blue-50 border border-blue-200 text-blue-600 flex items-center justify-between text-sm">
          ...
          <div className="space-y-8">
            <div className="grid gap-8 lg:grid-cols-3">
                  ...
                  <div className="flex gap-4 mb-6">
                    <div className="relative flex-1 rounded-lg shadow-sm">
                      ...
                      <input
                        ...
                        className="block w-full pl-9 pr-3 py-2 border border-gray-200 bg-white/50 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent text-sm"
                      />
                    </div>
                    ...
                    <select
                      ...
                      className="px-3 py-2 border border-gray-200 bg-white/50 rounded-lg text-gray-900 text-sm focus:outline-none"
                    >
                  ...
                  {patientsLoading ? (
                    ...
                    <div className="overflow-x-auto">
                      <table className="min-w-full divide-y divide-gray-200 text-sm text-left">
                        <thead>
                          <tr className="text-gray-600 uppercase tracking-widest text-sm font-bold border-b border-gray-200">
                            ...
                            >
                              ...
                              <td className="py-3.5 text-right space-x-2">
                                <button
                                  ...
                                  className="text-sm px-2.5 py-1 rounded bg-blue-50 text-blue-600 font-bold hover:bg-blue-600 hover:text-white transition-colors"
                                >
                                  Check In
                                </button>
                                ...
                                <button
                                  ...
                                  className="text-sm p-1 rounded bg-rose-500/10 text-rose-500 hover:bg-rose-500 hover:text-white transition-colors"
                  ...
                  <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="px-3 py-1 rounded border border-gray-200 hover:bg-blue-50 disabled:opacity-50 text-base font-semibold"
                      >
                        Prev
                      </button>
                      <button
              ...
              <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-200 h-fit">
                ...
                {regMessage && (
                  <div
                    className={`p-3 text-sm rounded-lg mb-4 ${regMessage.startsWith("Success") ? "bg-blue-50 text-blue-600 border border-blue-200" : "bg-rose-500/15 text-rose-500 border border-rose-500/20"}`}
                  >
                    {regMessage}
                  </div>
                )}
                ...
                <form
                  ...
                  className="space-y-4 text-base font-semibold text-gray-700"
                >
                  <div>
        ...
        {activeTab === "book" && (
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-md border border-gray-200">
              ...
              {bookingMessage && (
                <div
                  className={`p-3 text-sm rounded-lg mb-4 ${bookingMessage.startsWith("Success") ? "bg-blue-50 text-blue-600 border border-blue-200" : "bg-rose-500/15 text-rose-500 border border-rose-500/20"}`}
                >
                  {bookingMessage}
                </div>
              )}
                        ...
                        >
                          ...
                          <td className="py-3.5">
                            <button
                              ...
                              className="font-bold text-blue-600 hover:underline hover:text-blue-600 transition-colors"
                            >
                              {app.patient
                                ? app.patient.name
                                : "Unknown Patient"}
                          ...
                          <td className="py-3.5">
                            <span
                              className={`inline-flex px-2 py-0.5 rounded text-sm font-extrabold tracking-wide uppercase ${app.status === "COMPLETED" ? "bg-blue-50 text-blue-600" : app.status === "CANCELLED" ? "bg-rose-500/10 text-rose-500" : "bg-amber-500/10 text-amber-500"}`}
                            >
                              {app.status}
                            </span>
                          </td>
                            ...
                            {app.status === "PENDING" && (
                              <>
                                <button
                                  ...
                                  className="text-sm px-2.5 py-1 rounded bg-blue-50 text-blue-600 font-extrabold hover:bg-blue-600 hover:text-white transition-colors"
                                >
                                  Check In Patient
                                </button>
                                <button
                                  ...
                                  className="text-sm px-2.5 py-1 rounded bg-gray-50 text-gray-700 font-extrabold hover:bg-blue-600 hover:text-white transition-colors"
                                >
                                  Complete
                                </button>
                              </>
              ...
              <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-md space-y-4">
                <div className="flex justify-between items-start">
                  ...
                  <button
                    ...
                    className="text-base font-bold text-gray-600 hover:text-gray-700"
                  >
                    Close
                  </button>
                </div>

                <div className="p-4 rounded-xl bg-gray-50 border border-gray-200 text-base space-y-2">
                  <h4 className="font-bold text-gray-600 uppercase tracking-wider">
                    Clinical Background Information
                  </h4>

                  {/* Fixed nullable property access with optional chaining */}
                  <p className="text-gray-700 leading-5 text-sm font-semibold">
            ...
            {doctorQueue.length === 0 ? (
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {doctorQueue.map((t) => (
                  <div
                    key={t.id}
                    className={`p-5 rounded-2xl border shadow-md relative overflow-hidden flex flex-col justify-between ${t.status === "CALLING" ? "border-blue-200 bg-blue-50" : "border-gray-200 bg-gray-50"}`}
                  >
                    <div className="flex justify-between items-start">
                      ...
                      <span
                        className={`px-2 py-0.5 rounded text-sm font-extrabold tracking-wide uppercase ${t.status === "CALLING" ? "bg-blue-600 text-white" : t.status === "COMPLETED" ? "bg-blue-50 text-blue-600" : "bg-amber-500/10 text-amber-500"}`}
                      >
                        {t.status}
                      </span>
                    </div>
                    ...
                    <div className="mt-6 flex gap-2">
                      {t.status === "WAITING" && (
                        <button
                          ...
                          className="flex-1 py-1.5 bg-blue-600 text-white font-bold text-sm rounded hover:bg-blue-600 transition-colors"
                        >
                          Call Patient
                        </button>
                      )}
                      {t.status === "CALLING" && (
                        <>
                          ...
                          <button
                            ...
                            className="flex-1 py-1.5 bg-rose-500/10 text-rose-500 font-bold text-sm rounded hover:bg-rose-500 hover:text-white transition-colors"
                          >
                            Skip / No Show
                          </button>
                        </>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-md">
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-blue-600 text-white font-extrabold text-base rounded-lg shadow hover:bg-blue-600 disabled:opacity-50 transition-colors"
                >
                  {adminReportLoading
                    ? "Aggregating..."
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid gap-4 sm:grid-cols-3">
                    <div className="p-4 bg-gray-50 border border-gray-200 rounded-xl">
                      <span className="text-sm uppercase tracking-wider text-gray-600 font-bold">
                        Total Physicians
                      </span>
                      ...
                      <tbody className="divide-y divide-gray-200">
                        {adminReportData.data.map((item) => (
                          ...
                          >
                            <td className="py-3.5 font-bold text-gray-900">
                              {item.name}
                              <span className="block text-sm text-blue-600 font-semibold uppercase mt-0.5">
                                {item.specialization}
                              </span>
                            </td>
                            <td className="py-3.5 text-gray-600">
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-md space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className="px-5 py-2 bg-gray-50 text-white font-bold text-base rounded-lg hover:bg-gray-50 :bg-blue-600 transition-colors"
              >
                Execute SQL Query
              </button>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {doctorsList.map((doc) => (
                <div
                  key={doc.id}
                  className="p-5 rounded-2xl border border-gray-200 bg-gray-50 flex flex-col justify-between"
                >
                  <div>
                    <span className="inline-flex px-2 py-0.5 rounded text-sm font-extrabold tracking-wide uppercase bg-blue-50 text-blue-600 mb-2">
                      {doc.department}
                    </span>
                    <h4 className="font-extrabold text-gray-900">{doc.name}</h4>
                    <p className="text-base text-gray-600 mt-0.5">
                      {doc.specialization}
                    </p>
                  </div>
                  <div className="mt-6 pt-3 border-t border-gray-200 flex justify-between items-center text-base font-semibold text-gray-600">
